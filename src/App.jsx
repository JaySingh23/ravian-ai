...
const App = () => {
  ...
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      ...
      // Check if the screen size matches the small breakpoint (sm)
      const isSmallScreen = window.matchMedia('(max-width: 640px)').matches;

      // ScrollTrigger animation configuration for large screens
      if (!isSmallScreen) {
      ...
      } else { // ScrollTrigger animation configuration for small screens
        gsap.fromTo(servicesRef.current.children, {
          opacity: 0.5,
          y: 50,
        }, {
  ...
  return (
    <div className="relative" ref={comp}>
      ...
      <div className="h-screen bg-white">
        ...
        <div className="h-screen flex flex-col bg-black justify-center items-center z-1">
          <h1
            id="welcome"
            className="text-6xl sm:text-9xl font-bold text-gray-100 font-poppins z-20 "
          >
            Ravian AI
          </h1>
          <h3 id="tagline" className="text-lg sm:text-3xl text-gray-100 font-poppins z-20 text-center pl-5 pr-5">
      ...
      <div className="offerings-section bg-white pl-10 pr-10" ref={servicesRef}>
        <h1 className="text-6xl sm:text-8xl font-semibold text-white font-poppins">Our Offerings</h1>
        <div className="container mx-auto flex flex-col sm:flex-row justify-around items-start gap-10 pt-10">
        <Atropos
          activeOffset={40}
          shadowScale={1.05}
        ...
        <div className="vision-section pt-40 pb-20 " ref={visionRef}>
          <h1 className="text-6xl sm:text-8xl font-semibold text-white font-poppins mb-10">Our Vision</h1>
          <div className="container mx-auto p-4">
            <h3 className="text-4xl sm:text-5xl font-thin text-white">At Ravian, our vision is to redefine the frontiers of data science by integrating artificial intelligence with human ingenuity.</h3>
        ...
        <div className="about-section pt-40 " ref = {aboutRef} >
          <h1 className="text-6xl sm:text-8xl font-semibold text-white font-poppins mb-10">About Us</h1>
          <div className="container mx-auto p-4">
            <h3 className="text-4xl sm:text-5xl font-thin text-white">At Ravian, we are dedicated to transforming the landscape of data analytics through innovation and cutting-edge technology</h3>
            <p className="text-xl font-light text-white pt-10 w-11/12">
        ...
        <div className="cta-section pt-20 " ref = {ctaRef}>
          <h1 className="text-7xl sm:text-8xl font-semibold text-white font-poppins mb-10">What are you waiting for?</h1>
